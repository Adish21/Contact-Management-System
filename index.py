#Importing Libraries AND SQLITE3
from tkinter import *
import sqlite3
...
#Functions/Methods which will work for our project
def Database():
...
def OnSelected(event):
    ...
    #The labels of for the form/ data entry in the contact form
    ...
    #Section where data will be entered
...
#function which will delete the data from database    
def DeleteData():
...
#TabLE UI where the data will be shown
